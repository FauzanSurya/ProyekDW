...
<head>
    ...
    <style>
        ...
        .exp-org { background-image: url('{{ asset('images/organisasi.jpg') }}'); }
        .exp-panitia { background-image: url('{{ asset('images/kepanitiaan.jpg') }}'); }
        .exp-magang { background-image: url('{{ asset('images/magang.jpg') }}'); }
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-danger" href="{{ route('about') }}">About Me</a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 text-center" data-aos="fade-right" data-aos-delay="200">
                    <div class="profile-container">
                        <img src="{{ asset('images/profile.jpg') }}" class="profile-img" alt="Foto Profil">
                    </div>
                </div>
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="400">
                    <div class="bio-card">
                        <p class="bio-intro">{{ $profile->description ?? 'Data deskripsi belum diisi.' }}</p>
                        <table class="table table-borderless table-bio">
                            <tbody>
                                <tr><td class="label-bio">Nama Lengkap</td><td>: {{ $profile->name ?? '-' }}</td></tr>
                                <tr><td class="label-bio">Tempat, Tgl Lahir</td><td>: {{ $profile->birth_date ?? '-' }}</td></tr>
                                <tr><td class="label-bio">Alamat</td><td>: {{ $profile->address ?? '-' }}</td></tr>
                                <tr><td class="label-bio">Email</td><td>: {{ $profile->email ?? '-' }}</td></tr>
                                <tr><td class="label-bio">Pendidikan</td><td>: {{ $profile->education ?? '-' }}</td></tr>
                                <tr><td class="label-bio">Hobi</td><td>: {{ $profile->hobby ?? '-' }}</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item" data-aos="fade-up" data-aos-delay="100">
                        <div class="edu-card">
                            <div class="edu-year"><i class="fas fa-calendar-alt me-2"></i>{{ $edu->year }}</div>
                            <h3 class="edu-school">{{ $edu->school }}</h3>
                            @if($edu->major)<div class="edu-major">{{ $edu->major }}</div>@endif
                ...
                <div class="row g-4">
                    <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#modalOrg" data-aos="fade-up" data-aos-delay="100">
                        <div class="exp-card exp-org">
                            ...
                            <p class="exp-desc">{{ $experience->organization_summary ?? 'Belum ada data.' }}</p>
                    ...
                    <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#modalPanitia" data-aos="fade-up" data-aos-delay="300">
                        <div class="exp-card exp-panitia">
                            ...
                            <p class="exp-desc">{{ $experience->committee_summary ?? 'Belum ada data.' }}</p>
                    ...
                    <div class="col-md-4" data-bs-toggle="modal" data-bs-target="#modalMagang" data-aos="fade-up" data-aos-delay="500">
                        <div class="exp-card exp-magang">
                            ...
                            <p class="exp-desc">{{ $experience->internship_summary ?? 'Belum ada data.' }}</p>
        ...
        <footer class="footer-section" data-aos="fade-up">
            <div class="container">
                <div class="social-icons">
                    ...
                    <a href="{{ $item->url }}" class="social-item" title="{{ $item->platform }}" target="_blank"><i class="{{ $item->icon }}"></i></a>
                    @endforeach
                </div>
