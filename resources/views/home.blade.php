        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    <li class="nav-item"><a class="nav-link active text-danger" href="{{ route('home') }}">Home</a></li>
            ...
            <div class="container">
                <div class="row align-items-center">
                        ...
                        <div class="flip-card-container">
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-front">
                                    <img src="{{ asset('images/home1.jpg') }}" class="flip-img" alt="Foto Depan">
                                </div>
                                
                                <div class="flip-card-back">
                                     <img src="{{ asset('images/home2.jpg') }}" class="flip-img" style="filter: brightness(0.7);" alt="Foto Belakang">
                                </div>
                    ...
                    <div class="col-lg-6 hero-text-wrapper" data-aos="fade-left" data-aos-duration="1200">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('about') }}" class="btn btn-explore rounded-pill px-4 py-2 fw-bold">Explore Me</a>
                        </div>
                    </div>
        ...
        <footer class="footer-section" data-aos="fade-up" data-aos-duration="1000">
            <div class="container">
                <div class="social-icons">
                    ...
                    <a href="{{ $item->url }}" class="social-item" title="{{ $item->platform }}" target="_blank" data-aos="zoom-in" data-aos-delay="300">
                        <i class="{{ $item->icon }}"></i>
                    </a>
                    @endforeach
                </div>
