        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link active text-danger" href="{{ route('projects') }}">Project</a></li>
    ...
    <div class="main-content">
        ...
        <div class="container pb-5">
            <div class="row g-4"> 
                ...
                <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="{{ $index * 150 }}">
                    <div class="project-card text-start">
                        <div class="card-body d-flex flex-column h-100">
                            ...
                            <div class="mt-auto d-flex gap-2">
                                <a href="{{ $item->link }}" class="btn-custom">View Detail</a>
                                @if($item->pdf_file)
                                <a href="{{ asset($item->pdf_file) }}" target="_blank" class="btn-custom btn-pdf">
