        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link active text-danger" href="{{ route('skill') }}">Skill</a></li>
    ...
    <div class="main-content">
        ...
        <div class="container py-5">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4" data-aos="flip-left" data-aos-delay="{{ $index * 150 }}">
                    <div class="sport-card">
                        <div class="sport-img-wrapper">
                            <div class="category-badge">
                                <i class="fas fa-trophy me-1"></i> {{ $item->category }}
                            </div>
                            <img src="{{ $item->image }}" class="sport-img" alt="{{ $item->title }}">
                            <div class="card-info">
                                <div class="sport-title">{{ $item->title }}</div>
