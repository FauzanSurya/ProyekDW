        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-danger" href="<?php echo e(route('product')); ?>">Product</a>
    ...
    <div class="main-content">
        ...
        <div class="container product-gallery" id="section-gallery">
            <div class="row"> 
                ...
                <div class="col-md-3 col-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                    <div class="product-item">
                        <img src="<?php echo e($item->image); ?>" class="product-img" alt="<?php echo e($item->name); ?>">
